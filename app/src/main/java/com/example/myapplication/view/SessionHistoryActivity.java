...
public class SessionHistoryActivity extends AppCompatActivity {
    ...
    private HistoryFilter currentFilter = HistoryFilter.TODAY;
    ...
    private void setupFilterLogic() {
        chipFilterToday.setOnClickListener(v -> {
            currentFilter = HistoryFilter.TODAY;
            updateHistoryDisplay();
        });

        chipFilterWeek.setOnClickListener(v -> {
            currentFilter = HistoryFilter.WEEK;
            updateHistoryDisplay();
        });
        ...
        // Aseguramos selección inicial coherente.
        chipGroupFilter.check(R.id.chipFilterToday);
    }
    ...
    private void updateHistoryDisplay() {
        ...
        switch (currentFilter) {
            case WEEK:
                sessions = sessionManager.getThisWeekSessions();
                break;
            case ALL:
            ...
            case TODAY:
            default:
                sessions = sessionManager.getTodaySessions();
                break;
        }
